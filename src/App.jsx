...
// Genera una "huella" única del archivo basada en metadata
      ...
      <div className="upload-container glass">
        ...
        <div className="name-input-group">
          ...
          {!uploaderName.trim() && selectedFiles.length > 0 && (
            <p className="name-warning">⚠ Ingresá tu nombre para poder subir</p>
          )}
        </div>
        ...
        {selectedFiles.length > 0 && (
          ...
          >
            {isUploading ? 'Subiendo...' : !uploaderName.trim() ? 'Ingresá tu nombre primero' : `Subir ${selectedFiles.length} archivos`}
          </button>
        )}
